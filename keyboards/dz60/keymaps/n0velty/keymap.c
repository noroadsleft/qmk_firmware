...
[_DL] = LAYOUT_true_hhkb( //default Layer
    ...
    KC_LSPO,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSPC, MO(_F1), \
...
[_F1] = LAYOUT_true_hhkb( //function Layer 1
    ...
    _______,          KC_MPRV, KC_MPLY, KC_MNXT, KC_VOLD, _______, _______, _______, _______, KC_PGDN, KC_DOWN,          _______, _______, \
...
[_F2] = LAYOUT_true_hhkb( //function Layer 2
    ...
    BL_TOGG,          BL_STEP, BL_INC,  BL_DEC,  _______, _______, _______, _______, _______, KC_ACL0, KC_MS_D,          _______, _______, \
