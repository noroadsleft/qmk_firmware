...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_all(
        KC_SLEP,          RGB_TOG, KC_F13,  KC_F14,  KC_F15,  _______, _______, _______, _______, _______, _______, _______, _______,    _______, KC_VOLD, KC_VOLU,
        ...
        _______, KC_NUBS, _______, _______, KC_CALC, _______, _______, _______, _______, _______, _______, _______, _______, _______,             RGB_VAI,
        _______, _______, _______,                            _______,                                     _______, _______, _______,   RGB_RMOD, RGB_VAI, RGB_MOD
    ),
