/* Copyright 2020-2021 bit-shifter
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_APL] = LAYOUT_h7v3_183(
        ...
        _______, _______, _______, _______,    _______, _______, _______, X(N_ARY_LOGICAL_AND), X(N_ARY_LOGICAL_OR), X(N_ARY_INTERSECT), X(N_ARY_UNION),  X(SUBSET_OF),               X(SUPERSET_OF),                 X(FORALL),             X(LEMNISCATE),            X(THERE_EXISTS),    X(PARTIAL_DIFFERENTIAL), _______, _______, _______, _______, _______,             _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______, _______, X(UP_TACK),           X(DOWN_TACK),        X(RIGHT_TACK),      X(LEFT_TACK),    X(UPWARDS_ARROW),           X(DOWNARDS_ARROW),              X(LEFTWARDS_ARROW),    X(RIGHTWARDS_ARROW),      X(LEFTRIGHT_ARROW), _______,                 _______, _______, _______, _______,                      _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______, _______, _______,              X(LEFT_FLOOR),       X(LEFT_CEILING),    X(NOT_EQUAL_TO), X(ASYMPTOTICALLY_EQUAL_TO), X(NOT_ASYMPTOTICALLY_EQUAL_TO), X(LESS_THAN_OR_EQUAL), X(GREATER_THAN_OR_EQUAL), _______,            _______,                 _______, _______, _______, _______, _______,             _______, _______, _______, _______,
    ...
    [_GREEK] = LAYOUT_h7v3_183(
        ...
        _______, _______, _______, _______,    _______, X(CONTOUR_INTEGRAL), _______, X(COPTIC_LC_DEI),                   X(DOUBLE_DAGGER),                   X(NABLA),                               X(CENT),                        X(DEGREE),                                X(APL_QUAD),                      X(DIVISION),                            X(MULTIPLICATION),                  X(PILCROW),                             X(LARGE_CIRCLE),              X(HORIZONTAL_BAR),                         X(APPROXIMATELY_EQUAL_TO),                  X(DOUBLE_VERTICAL_LINE), X(SQUARE_IMAGE_OF), X(SQUARE_ORIGINAL_OF), _______,    _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______,             _______, XP(GREEK_LC_THETA, GREEK_UC_THETA), XP(GREEK_LC_OMEGA, GREEK_UC_OMEGA), XP(GREEK_LC_EPSILON, GREEK_UC_EPSILON), XP(GREEK_LC_RHO, GREEK_UC_RHO), XP(GREEK_LC_TAU, GREEK_UC_TAU),           XP(GREEK_LC_PSI, GREEK_UC_PSI),   XP(GREEK_LC_UPSILON, GREEK_UC_UPSILON), XP(GREEK_LC_IOTA, GREEK_UC_IOTA),   XP(GREEK_LC_OMICRON, GREEK_UC_OMICRON), XP(GREEK_LC_PI, GREEK_UC_PI), X(MATHEMATICAL_LEFT_WHITE_SQUARE_BRACKET), X(MATHEMATICAL_RIGHT_WHITE_SQUARE_BRACKET), _______,                 _______,            _______,                           _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______,             _______, XP(GREEK_LC_ALPHA, GREEK_UC_ALPHA), XP(GREEK_LC_SIGMA, GREEK_UC_SIGMA), XP(GREEK_LC_DELTA, GREEK_UC_DELTA),     XP(GREEK_LC_PHI, GREEK_UC_PHI), XP(GREEK_LC_GAMMA, GREEK_UC_GAMMA),       XP(GREEK_LC_ETA, GREEK_UC_ETA),   XP(GREEK_LC_YOT, GREEK_UC_YOT),         XP(GREEK_LC_KAPPA, GREEK_UC_KAPPA), XP(GREEK_LC_LAMDA, GREEK_UC_LAMDA),     X(TWO_DOT_LEADER),            X(BULLET),                                 _______,                                    _______,                 _______,                                               _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______,             _______, _______,                            XP(GREEK_LC_ZETA, GREEK_UC_ZETA),   XP(GREEK_LC_XI, GREEK_UC_XI),           XP(GREEK_LC_CHI, GREEK_UC_CHI), XP(GREEK_LC_FINAL_SIGMA, GREEK_UC_SIGMA), XP(GREEK_LC_BETA, GREEK_UC_BETA), XP(GREEK_LC_NU, GREEK_UC_NU),           XP(GREEK_LC_MU, GREEK_UC_MU),       X(MUCH_LESS_THAN),                      X(MUCH_GREATER_THAN),         X(INTEGRAL),                               _______,                                    _______,                 _______,            _______,                           _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______,             _______, _______,                            _______,                            _______,                                _______,                        _______,                                  _______,                          _______,                                _______,                            _______,                                _______,                      _______,                                   _______,                                    _______,                 _______,                                               _______, _______, _______, _______
    ),
    ...
    [_FN] = LAYOUT_h7v3_183(
        ...
        _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______, _______, _______, UC_M_WI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,             _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, UC_MOD,  _______, _______, _______, _______, _______, _______, _______, _______, _______, UC_M_LN, _______, _______, _______, _______, _______,                      _______, _______, _______, _______,
        _______, _______, _______, H_LOCK,     _______, _______, _______, _______, _______, _______, UC_M_WC, _______, _______, _______, UC_M_MA, _______, _______, _______, _______, _______, _______, _______,             _______, _______, _______, _______,
        _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                      _______, _______, _______, _______
    )
