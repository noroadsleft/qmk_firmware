...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_ortho_4x12(
        ...
        _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, KC_PSCR,
        MO(2),   MO(2),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
