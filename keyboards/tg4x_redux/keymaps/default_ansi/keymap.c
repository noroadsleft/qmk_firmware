...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT_ansi( /* Base */
        ...
        KC_LCTL, KC_LALT, MO(_FL),                            KC_SPC,                             KC_LEFT, KC_UP,   KC_RGHT
    ),
     ...
     * |---------,--'------,'-------',------'-------'-------'-------'-------'-------',------'--,----'--,-------|
     * |   Ctl   |   Win   |   Fn    |   FnOL                                        |  Left   | Down  | Right |
     * `---------'---------'---------'-----------------------------------------------'---------'-------'-------'
     */
    [_FL] = LAYOUT_ansi( /* Function */
        ...
        _______, KC_LGUI, _______,                            MO(_OL),                            KC_LEFT, KC_DOWN, KC_RGHT
    ),
     ...
     * `---------'---------'---------'-----------------------------------------------'---------'-------'-------'
     */
    [_OL] = LAYOUT_ansi( /* Other Function */
