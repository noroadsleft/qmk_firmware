...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------,---'-----,-'-------+-------'-------'-----,-'-------'-------+-------'-,-----'-,-----'-,-------|
     * |   Ctl   |   Win   |   Alt   |   Fn/Spc            |   Spc           |  RAlt   | RWin  |  Fn   | RCtl  |
     * `---------'---------'---------'---------------------'-----------------'---------'-------'-------'-------'
     */
     ...
     * |---------,---'-----,-'-------+-------'-------'-----,-'-------'-------+-------'-,-----'-,-----'-,-------|
     * |   Ctl   |   Win   |   Alt   |   Fn/Spc            |   Spc           |  Ralt   | Left  | Down  | Right |
     * `---------'---------'---------'---------------------'-----------------'---------'-------'-------'-------'
     */
    [_FL] = LAYOUT_split_ansi( /* Function */
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_DEL,
        KC_CAPS, KC_HOME, KC_PGUP, _______, _______, _______, _______, KC_LBRC, KC_RBRC, KC_EQL,  KC_BSLS,          KC_ENT,
