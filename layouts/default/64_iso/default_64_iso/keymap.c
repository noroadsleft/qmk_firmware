...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_64_iso(
        ...
        _______, _______, KC_UP,   _______, _______, _______, KC_INS,  _______, _______, _______, _______, KC_PSCR, KC_SLCK,
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_DEL,  _______, _______, _______, _______, _______, KC_PAUS,          _______,
